...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Current time, date, timezone → read <current_time>, supplied every turn "
    "in the user's own timezone. Do NOT run `date`: it reports the container "
    "clock, which is not the user's timezone.\n"
    ...
    "- 'What time is it?' → read <current_time> on this turn (don't guess, "
    "don't run `date`)\n"
